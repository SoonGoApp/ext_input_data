"""
Tests unitaires pour app.py - Rent Cost ML Training
"""
...
def mock_all_deps():
    ...
    with patch("infrastructure.lambdas.rent_cost_ml_training.app.run_pipeline") as mock_run, \
         patch("infrastructure.lambdas.rent_cost_ml_training.app.gen_logger") as mock_logger, \
         patch("infrastructure.lambdas.rent_cost_ml_training.app.get_local_secret") as mock_secret, \
         patch("infrastructure.lambdas.rent_cost_ml_training.app.send_ses_email") as mock_email, \
...
def get_handler():
    ...
    import infrastructure.lambdas.rent_cost_ml_training.app as app_module
