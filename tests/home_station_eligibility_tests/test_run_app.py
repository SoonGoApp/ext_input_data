"""
Tests unitaires simples pour app.py
"""
...
class TestLambdaHandler:
    ...
    def test_lambda_handler_success(self, mock_dirname, mock_abspath, mock_file, mock_yaml, mock_run_pipeline, mock_config):
    ...
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.abspath')
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.dirname')
    def test_lambda_handler_with_context(self, mock_dirname, mock_abspath, mock_file, mock_yaml, mock_run_pipeline, mock_config):
    ...
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.abspath')
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.dirname')
    def test_lambda_handler_pipeline_exception(self, mock_dirname, mock_abspath, mock_file, mock_yaml, mock_run_pipeline, mock_config):
    ...
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.abspath')
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.dirname')
    def test_lambda_handler_config_file_not_found(self, mock_dirname, mock_abspath, mock_file, mock_yaml):
    ...
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.abspath')
    @patch('infrastructure.lambdas.home_station_eligibility.app.os.path.dirname')
    def test_lambda_handler_invalid_yaml(self, mock_dirname, mock_abspath, mock_file, mock_yaml, mock_run_pipeline):
