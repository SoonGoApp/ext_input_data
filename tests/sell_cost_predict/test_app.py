"""
Tests unitaires pour app.py - Sell Cost Predict
"""
...
def mock_all_deps():
    ...
    with patch("infrastructure.lambdas.sell_cost_ml_predict.app.run_pipeline") as mock_run, \
         patch("infrastructure.lambdas.sell_cost_ml_predict.app.gen_logger") as mock_logger, \
         patch("infrastructure.lambdas.sell_cost_ml_predict.app.get_local_secret") as mock_secret, \
         patch("infrastructure.lambdas.sell_cost_ml_predict.app.send_ses_email") as mock_email, \
...
def get_handler():
    ...
    import infrastructure.lambdas.sell_cost_ml_predict.app as app_module
